...
public class DomesticDivision extends Division implements DomesticInterface {

    // declare class variable
    public String divisionState;

    // class constructor - includes parent class variables
    public DomesticDivision(String companyDivisionName, String companyAccountNumber, String state) {
        super(companyDivisionName, companyAccountNumber);
        this.divisionState = state;
    }

    // override for class method to access variables
    @Override
